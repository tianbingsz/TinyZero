...
export HOME=/home/tianbing_xu/r1/TinyZero
echo "HOME: $HOME"
...
export EXPERIMENT_NAME=qwen2_1_5b_function_rm
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name='verl_grpo_example_gsm8k_1.5' \
    trainer.experiment_name=$EXPERIMENT_NAME \
    trainer.n_gpus_per_node=$N_GPUS \
    trainer.nnodes=1 \
    trainer.save_freq=-1 \
    trainer.test_freq=5 \
    trainer.total_epochs=15 2>&1 | tee verl_demo_grpo_1_29.log